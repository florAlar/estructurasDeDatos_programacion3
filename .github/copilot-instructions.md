...
`.copilot/agents/leader.md`. Tu trabajo es **descomponer y coordinar**, nunca
implementar.
...
- ❌ **No marques** features como `done` en `progress/tasks.json`.
...
4. Aplica la tabla de escalado de `.copilot/agents/leader.md`.

### Regla anti-teléfono-descompuesto

Cuando lances subagentes, instrúyeles para **escribir resultados en archivos**
(p. ej. `progress/explorer/explore_<tema>.md`) y devolverte solo la referencia, no el
contenido.
